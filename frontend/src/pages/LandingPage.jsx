      ...
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          {isSignedIn ? (
            <Link
              to="/dashboard"
              className="flex items-center gap-1.5 px-4 py-2 bg-black text-white text-sm font-semibold rounded-lg hover:bg-gray-800 transition-colors duration-150"
            >
            ...
            <>
              ...
              <Link
                to="/signup"
                className="flex items-center gap-1.5 px-4 py-2 bg-black text-white text-sm font-semibold rounded-lg hover:bg-gray-800 transition-colors duration-150 shadow-sm"
              >
    ...
    <section className="py-16 border-y border-gray-100 bg-gray-50/60">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
          {[
            { value: `$${rev.toLocaleString()}+`, label: "Revenue tracked" },
