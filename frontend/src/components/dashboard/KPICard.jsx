...
export default function KPICard({
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-5 hover:border-gray-300 transition duration-150 font-sans flex flex-col justify-between min-h-[110px] sm:min-h-[115px]">
      <div>
        <div className="flex justify-between items-center gap-1">
          <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest truncate">{title}</span>
